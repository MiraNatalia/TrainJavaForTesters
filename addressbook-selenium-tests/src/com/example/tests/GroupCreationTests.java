...
public class GroupCreationTests extends TestBase {
	...
	// v1. test method will receive test data out of an external
	...
	// without DB use
	// @Test(dataProvider = "groupsFromFile")
	// public void testGroupCreationWithValidData(GroupData group) throws
	// Exception {
	//
	// // save old state
	// SortedListOf<GroupData> oldGroups =
	// app.getGroupHelper().getGroupsOnPage();
	//
	// // actions
	// app.getGroupHelper().createGroup(group);
	//
	// // save new state
	// SortedListOf<GroupData> newGroups =
	// app.getGroupHelper().getGroupsOnPage();
	//
